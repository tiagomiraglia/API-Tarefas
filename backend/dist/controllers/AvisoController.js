...
class AvisoController {
    ...
    async getVisualizacoes(req, res) {
        try {
            const { id } = req.params;
...
//# sourceMappingURL=AvisoController.js.map