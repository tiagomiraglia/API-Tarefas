...
router.post('/', async (req, res) => {
    ...
    try {
        ...
        await pool.query('INSERT INTO pending_users (name, email, password, token, token_expires) VALUES (?, ?, ?, ?, DATE_ADD(?, INTERVAL 30 MINUTE))', [name, email, hash, token, tokenExpires]);
