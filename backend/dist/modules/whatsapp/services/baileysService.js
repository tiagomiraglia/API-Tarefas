...
exports.validateEmpresaId = validateEmpresaId;
...
exports.loadActiveSessions = loadActiveSessions;
...
exports.disconnectAllEmpresaSessions = disconnectAllEmpresaSessions;
exports.sendMessage = sendMessage;
exports.listActiveSessions = listActiveSessions;
exports.listEmpresaSessions = listEmpresaSessions;
exports.validateWhatsAppCompliance = validateWhatsAppCompliance;
 ...
 */
function validateEmpresaId(empresaId) {
 ...
 */
function recordFailedConnection() {
...
async function cleanupInactiveSessions() {
    try {
        ...
        const inactiveSessions = await prisma.whatsAppSession.findMany({
            where: {
                status: 'disconnected',
                disconnected_at: {
                    lt: cutoffTime
...
async function loadActiveSessions() {
    try {
        ...
        const activeSessionsFromDB = await prisma.whatsAppSession.findMany({
            where: {
                status: {
 ...
 */
function generateSessionId(empresaId, telefone) {
    if (telefone) {
 ...
 */
async function startSession(empresaId, telefone) {
    // Validar entrada
    const validatedEmpresaId = validateEmpresaId(empresaId);
    let validatedTelefone;
    if (telefone) {
 ...
 */
async function disconnectAllEmpresaSessions(empresaId) {
 ...
 */
function listEmpresaSessions(empresaId) {
    try {
 ...
 */
function validateWhatsAppCompliance(empresaId, telefone, message) {
    const warnings = [];
